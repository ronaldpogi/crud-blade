...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Edit Person</h1>
            <p class="text-sm text-gray-500">Update the selected person’s details.</p>
        </div>
        ...
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <input id="birthdate" name="birthdate" type="date"
                       value="{{ old('birthdate', $person->birthdate) }}"
                       class="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
            </div>
        </div>
