...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Add Contact</h1>
            <p class="text-sm text-gray-500">
                New contact detail for {{ $person->first_name }} {{ $person->last_name }}.
            </p>
        </div>
    ...
    <form method="POST" action="{{ route('people.contacts.store', $person->id) }}"
